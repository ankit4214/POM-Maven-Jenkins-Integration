...
public class CommonFunction {
	...
	public static void getscreenshot(String testname,WebDriver driver) throws Exception 
    {
		...
		Date date=new Date();
		String datestr=format.format(date);
		String filename=System.getProperty("user.dir")+"\\src\\com\\vtiger\\reports\\screenshot\\"+testname+"_"+datestr+".png";
	...
	//for POM
	/*public static void selectvisibletext(WebDriver driver,By elm,String val)
	{
